...
namespace ProductInventoryManager.Controllers
{
    public class InvoicesController : Controller
    {
        ...
        public InvoicesController(ProductsDbContext context)
        {
            _context = context;
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,CustomerName,IsPaid,Discount,CreatedAt,UpdatedAt,Email")] Invoice invoice)
        {
            if (id != invoice.Id)
            {
                return NotFound();
